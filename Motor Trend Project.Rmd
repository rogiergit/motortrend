...
y <- cbind(var = "hp",rsquared = summary(lm(mpg ~ hp , data = trend))$r.squared)
y <- cbind(var = "drat",rsquared = summary(lm(mpg ~ drat , data = trend))$r.squared)
y <- cbind(var = "wt",rsquared = summary(lm(mpg ~ wt , data = trend))$r.squared)
y <- cbind(var = "vs",rsquared = summary(lm(mpg ~ vs , data = trend))$r.squared)
y <- cbind(var = "am",rsquared = summary(lm(mpg ~ am , data = trend))$r.squared)
y <- cbind(var = "carb",rsquared = summary(lm(mpg ~ carb , data = trend))$r.squared)
